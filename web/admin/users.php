...
<head>
	<meta charset="utf-8" />
	<title>Gestion de flux Weezjump | Utilisateurs</title>
...
<body>
	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
		...
		<div id="content" class="content">
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Utilisateurs Enregistrés</h1>
			<!-- end page-header -->
			...
			<div class="row">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><a href="enregistrement.php" title="Modifier cet utilisateur"><i class="fa fa-pencil"></i></a></td>
                                        <td><a href="#" title="Supprimer cet utilisateur"><i class="fa fa-trash"></i></a></td>
                                    </tr>
                                    <tr>
                                        <td>2</td>
                                        <td>Edmund Wong</td>
			    ...
			    <div class="col-md-12">
				    <a href="enregistrement.php"><div class="btn btn-primary m-r-5">Nouvel utilisateur</div></a>
			    </div>		
			</div>
			<!-- end row -->
		</div>
